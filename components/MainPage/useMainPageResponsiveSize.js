...
const useMainPageResponsiveSize = () => {
  ...
  React.useEffect(() => {
    ...
    const Property1MobileSize = window.matchMedia('(max-width: 610px)');
    setVariant((size) =>
    ...
    const Property1TabletSize = window.matchMedia(
      '(min-width: 611px) and (max-width: 1142px)'
    );
    setVariant((size) =>
    ...
    const Property1DesktopSize = window.matchMedia('(min-width: 1143px)');
    setVariant((size) =>
...
export default useMainPageResponsiveSize;
